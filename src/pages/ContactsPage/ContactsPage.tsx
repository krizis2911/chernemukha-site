      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-4 text-center">
          ...
          <p>
            ...
            <a
              href="https://t.me/bathhouse_68"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sky-600 hover:text-sky-700 hover:underline"
            >
              Написать&nbsp;в&nbsp;Telegram {/* ← вот здесь заменили текст */}
            </a>
          </p>
          ...
          <div className="mt-8">
            ...
            <p className="mt-6">
              ...
              <br />
              Всего 8 км от центра Тамбова. Едете по Рассказовскому шоссе, после
              Кривого моста — налево, и ещё ≈ 5 км по Старой Тулиновской дороге.
              Вся дорога асфальтирована, покрытие ровное.
            </p>
          </div>
        </div>
      </div>
